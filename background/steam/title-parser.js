...
export function parseGameTitle(rawName) {
  ...
  const junkPattern = /^(豪华|解压即撸|预购特典|预购|特典|中文|汉化|破解|免安装|绿色|完整版|豪华版|终极|修改器|加速器|作弊|build[.\s]*\d+|\d+[\d.]*|v[\d.]+)$/i;
